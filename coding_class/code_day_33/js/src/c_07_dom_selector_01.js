...
//#wrap {}
var wrap = document.getElementById('wrap'); //ID를 제외하면 다른 선택자들은 복수이다.
wrap.style = 'width:90%; margin:auto; background-color:#fda; padding:0.5rem; ';

//h1
var h1 =wrap.getElementsByTagName('h1')[0]; //이유불문 배열형식으로 담긴다.
//[순서]를 지정 해야 사용가능, 자손선택자.
h1.style = 'width:100px; height:30px; background-color:#dfd;';

var h1Link = h1.children;//공통. 자식선택자
h1Link[0].style = 'padding:0.5rem; color:#05f;';
h1Link[1].classList.add('blind');
//console.log( h1Link );
var navArea = wrap.getElementsByClassName('nav_area');
//var navArea2 = wrap.getElementsByTagName('nav')[0].className === 'nav_area'; //구형브라우저
...
var navLi = navUl.children;//자식선택자
console.log(navLi);

//-=========================================================================

var headBox = document.querySelector('#headBox'); //자손선택자
headBox.style = 'width:100%; height:auto; background-color:#adf;';

var headH1 = headBox.querySelector('h1');
//headH1.style = 'border-radius:5px; fonst-size:1.2rem;'
headH1.style.borderRadius='5px';
headH1.style.fontSize='1.2rem'; //이후의 내용을 추가하기위한 방법 

var h1Insert = headH1.childNodes; //관계형성 체크
...
var navLi2 = navArea3.querySelectorAll('Li'); //자손선택자
console.log (navLi2);
